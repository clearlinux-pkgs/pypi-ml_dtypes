...
Version  : 0.4.0
Release  : 12
URL      : https://files.pythonhosted.org/packages/dd/50/17ab8a66d66bdf55ff6dea6fe2df424061cee65c6d772abc871bb563f91b/ml_dtypes-0.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/dd/50/17ab8a66d66bdf55ff6dea6fe2df424061cee65c6d772abc871bb563f91b/ml_dtypes-0.4.0.tar.gz
...
%prep
%setup -q -n ml_dtypes-0.4.0
cd %{_builddir}/ml_dtypes-0.4.0
pushd ..
cp -a ml_dtypes-0.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712001542
